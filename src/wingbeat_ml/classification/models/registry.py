...
from wingbeat_ml.classification.models.layers import RepConv1D, SincConv1D
...
def resolve_initializer(spec: dict[str, Any]) -> None:
    ...
    if isinstance(initializer, dict):
        ...
        if init_type == "fir_bandpass":
            from wingbeat_ml.classification.models.initializers.firbandpass import FIRBandpassInitializer
